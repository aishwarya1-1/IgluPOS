...
export function ComponentBar({ data }: { data: SalesDataEntry[] }) {
    ...
    <Card>
      <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
        <div className="flex flex-1 flex-col justify-center gap-1 px-6 py-5 sm:py-6">
          <CardTitle>Sales/Quantity Daily</CardTitle>
          <CardDescription>
            Shows the total sales and total quantity sold each day
          </CardDescription>
        </div>
        <div className="flex">
          {["totalSales", "totalQuantity"].map((key) => {
